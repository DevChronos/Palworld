    ...
    public partial class Esp
    {
        private static void DrawSettings()
        {
            if (ImGui.Begin("Settings"))
            {
                ...
                ImGui.TableNextColumn(); ImGui.Text("Egg");
                ImGui.TableNextColumn(); ImGui.Checkbox("##EnableEgg", ref Settings.EnableEgg);
                ImGui.TableNextColumn(); ImGui.ColorEdit4("##EggColor", ref Settings.EggColor, colorEditFlags);
                ImGui.TableNextColumn(); ImGui.DragInt("##EggDistance", ref Settings.EggDistance);
