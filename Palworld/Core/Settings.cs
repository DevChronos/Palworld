...
namespace Palworld.Core
{
    ...
    internal static class Settings
    {
        ...
        public static bool EnableEgg = Properties.User.Default.EnableEgg;
        public static Vector4 EggColor = Properties.User.Default.EggColor.ToVector4();
        public static int EggDistance = Properties.User.Default.EggDistance;
        ...
        public static void Save()
        {
            ...
            Properties.User.Default.EnableEgg = EnableEgg;
            Properties.User.Default.EggColor = EggColor.ToUint();
            Properties.User.Default.EggDistance = EggDistance;
